...
class UserMailerPreview < ActionMailer::Preview
  def initialize(_params)
    @logo = "https://www.immigrant-education.ca/wp-content/uploads/2019/07/TIES-Websafe-Logo.png"
    @color = "#467fcf"
  end
  ...
  def user_promoted
    ...
    logo_image = "https://www.immigrant-education.ca/wp-content/uploads/2019/07/TIES-Websafe-Logo.png"
    user_color = "#467fcf"
